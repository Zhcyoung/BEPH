...
study_dir = '/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/CLAM_feature/STAD/FEATURES_DIRECTORY_hipt/pt_files/'
def main(args):
    ...
    for i in folds:
        ...
        ckpt_path = '/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/HIPT/2-Weakly-Supervised-Subtyping/results_survival/tcga_prcc_subtype/2e-3_DINO/tcga_prcc_subtype/tcga_prcc_subtype_clam_sb_vits_tcga_pancancer_dino_1.00_none_s123/s_'+str(i)+'_checkpoint.pt'
