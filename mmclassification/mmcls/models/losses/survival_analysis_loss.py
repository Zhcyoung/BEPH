...
class SurvivalAnalysisLoss(nn.Module):
    ...
    def forward(self,
        ...
        assert one_hot_like_label.shape == cls_score.shape, \
            f'SurvivalAnalysisLoss requires output and target ' \
