...
from HIPT_4K.vision_transformer4k import vit4k_xs
from Hierarchical_Pretraining.main_dino4k import DataAugmentationDINO4K
...
if __name__ == '__main__':
    ...
    print('loading model checkpoint',device)
    # model = resnet50_baseline(pretrained=True)
    weight = '/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/HIPT/HIPT_4K/Checkpoints/vit256_small_dino.pth'
