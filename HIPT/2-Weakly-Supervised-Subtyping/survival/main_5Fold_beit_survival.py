...
import math
import sys
sys.path.append(r"../../../WSI_Classification/")
### Numerical Packages
import numpy as np
import pandas as pd

### Internal Imports
from datasets.dataset_generic_survival import Generic_WSI_Classification_Dataset, Generic_MIL_Dataset
...
def main(args):
    ...
    for i in folds:
        ...
        val_index = train(datasets, i, args)
...
parser.add_argument('--features',       type=str, default='beph', help='Which features to use',
                    choices=['beph', 'resnet','dino','ctranspath'])
...
study_dir = args.data_root_dir
if args.task == 'tcga_lung_subtype':
    args.n_classes = 2
    dataset = Generic_MIL_Dataset(csv_path = '../dataset_csv/TCGA_LUAD.csv',
    ...
    args.n_classes = 2
    dataset = Generic_MIL_Dataset(csv_path =  '../dataset_csv/TCGA_CRC.csv',
                            data_dir= os.path.join(args.data_root_dir, study_dir),
                            mode=args.mode,
                            shuffle = False, 
                            seed = args.seed, 
    ...
    args.n_classes = 2
    dataset = Generic_MIL_Dataset(csv_path =  '../dataset_csv/TCGA_STAD.csv',
                            data_dir= os.path.join(args.data_root_dir, study_dir),
                            mode=args.mode,
                            shuffle = False, 
                            seed = args.seed, 
    ...
    args.n_classes = 2
    dataset = Generic_MIL_Dataset(csv_path =  '../dataset_csv/TCGA_KIRC.csv',
                            data_dir= os.path.join(args.data_root_dir, study_dir),
                            mode=args.mode,
                            shuffle = False, 
                            seed = args.seed, 
    ...
    args.n_classes = 2
    dataset = Generic_MIL_Dataset(csv_path = '../dataset_csv/TCGA_PRCC.csv',
                            data_dir= os.path.join(args.data_root_dir, study_dir),
                            mode=args.mode,
                            shuffle = False, 
                            seed = args.seed, 
    ...
    dataset = Generic_MIL_Dataset(csv_path = '../dataset_csv/tcga_brca_all_clean_survival.csv',
                            data_dir= os.path.join(args.data_root_dir, study_dir),
                            mode=args.mode,
                            shuffle = False, 
                            seed = args.seed, 
