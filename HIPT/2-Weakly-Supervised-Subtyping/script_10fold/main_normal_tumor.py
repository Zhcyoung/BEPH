...
def main(args):
    ...
    for i in folds:
        ...
        with open(args.results_dir+'/fold_'+str(i)+'.txt','w') as f:
            f.write("test_auc:{}, val_auc：{}, test_acc：{}, val_acc：{}\n".format(test_auc, val_auc, test_acc, val_acc ))
...
parser.add_argument('--split_dir',    type=str, help='split directory (default: ./splits)')
...
study_dir = '/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/CLAM_feature/CAMELYON16/FEATURES_DIRECTORY_beit/pt_files/'

if args.task == 'task_1_tumor_vs_normal':
    args.n_classes = 2
    dataset = Generic_MIL_Dataset(csv_path = '/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/HIPT/2-Weakly-Supervised-Subtyping/dataset_csv/CAMELYON16.csv',
