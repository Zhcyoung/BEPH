...
### Internal Imports
from datasets_CLAM.dataset_generic_hipt import Generic_WSI_Classification_Dataset, Generic_MIL_Dataset
from utils.file_utils import save_pkl, load_pkl
from utils.utils import *
from utils.core_utils_hipt import train
...
if 'subtype' in args.task:
    ...
    args.splits = './10foldcv_subtype_redo/p100/back/'
...
if args.mode == 'pyramid':
    ...
    study_dir = '/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/CLAM/BRCA/FEATURES_DIRECTORY_hipt_dino/pt_files/'
else:
...
if args.task == 'tcga_lung_subtype':
    ...
    args.n_classes = 2
    dataset = Generic_MIL_Dataset(csv_path = '/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/CLAM/BRCA/FEATURES_DIRECTORY/tcga_brca_subset.csv',
                            data_dir= os.path.join(args.data_root_dir, study_dir),
                            mode=args.mode,
                            shuffle = False, 
                            seed = args.seed, 
