...
import sys
sys.path.append('/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/HIPT/HIPT_4K/')
    ...
    def __init__(self, path_input_dim=384,  size_arg = "small", dropout=0.25, n_classes=4,
     pretrain_4k='None', freeze_4k=False, pretrain_WSI='None', freeze_WSI=False):
        ...
        if pretrain_4k != 'None':
            ...
            state_dict = torch.load('/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/HIPT/HIPT_4K/Checkpoints/vit4k_xs_dino.pth', map_location='cpu')['teacher']
