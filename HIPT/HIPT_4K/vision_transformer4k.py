...
sys.path.append('/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/HIPT')
import HIPT_4K.vision_transformer as vits
from HIPT_4K.vision_transformer import DINOHead
...
class VisionTransformer4K(nn.Module):
    ...
    def __init__(self, num_classes=0, img_size=[224], input_embed_dim=384, output_embed_dim = 192,
        ...
        self.feature_linear = nn.Linear(768,384)
    ...
    def prepare_tokens(self, x):
        ...
        x = x.flatten(2, 3).transpose(1,2).float()
