...
class HIPT_4K(torch.nn.Module):
    ...
    """
    def __init__(self, 
        model256_path: str = '/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/HIPT/HIPT_4K/Checkpoints/vit256_small_dino.pth',
        model4k_path: str = '/dssg/home/acct-medftn/medftn/BEPT/Model/benchMark/HIPT/HIPT_4K/Checkpoints/vit4k_xs_dino.pth', 
